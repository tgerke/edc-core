...
permission can see its value; everyone else sees a locked `[BLINDED]` field.
Typically the treatment arm in a blinded trial. See
[Data capture](guide/data-capture.qmd#blinded-items).
...
See [Analytics workbench](guide/analytics.qmd#exports-and-the-study-archive).
...
[Study builds](guide/study-builds.qmd#edit-checks).
...
[Analytics workbench](guide/analytics.qmd#exports-and-the-study-archive).
...
[Study builds](guide/study-builds.qmd#dynamic-fields).
...
manifests into an external eTMF automatically.
