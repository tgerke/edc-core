...
Manual queries can also be opened in bulk from a workbench listing: a
cleaning query's result rows become queries, each carrying provenance back
to the exact execution and snapshot that flagged it. See
...
![Queries dashboard](../../../assets/screenshots/queries.png)
...
silences are on the [notifications page](/edc-core/guide/notifications/).
...
![The electronic-signature panel on a completed form: a Part 11 statement, credential fields, and the signature meaning, shown before signing](../../../assets/screenshots/sign-form.png)
