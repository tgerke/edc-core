...
protocols, read [Why protocol-first?](why-protocol-first.qmd) first; this page
is the how-to.
...
![](../images/protocol-review.png){.screenshot fig-alt="The protocol review screen: the schedule of activities compiled from a USDM package, with per-concept resolution badges and the publish action"}
...
version. From there the standard [amendment tooling](study-builds.qmd)
