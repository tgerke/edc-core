...
and derivation methods to fields and sections. A rules panel below the form
editor manages the conditions and methods themselves; JSONata expressions are
syntax-checked as you type. Nothing is persisted
...
1. **Diff:** compare any two builds for items added/removed/changed (data
   type, codelist, length, mandatory), edit checks, events, forms, and
   codelists.
