...
by construction (see the [blinding guide](blinding.qmd)).

![](../images/rtsm-panel.png){.screenshot fig-alt="The RTSM integration panel: intake configuration pointing at the arm item, API-key management, and the transfer log with an applied assignment"}
