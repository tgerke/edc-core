...
![](../images/users-admin.png){.screenshot fig-alt="Users administration page with account creation and lifecycle actions"}
...
![](../images/team.png){.screenshot fig-alt="Study team page listing role grants with their scopes"} Changing the team requires the `roles.grant` permission (held
...
![](../images/access-log.png){.screenshot fig-alt="Access log with per-request rows and filters"}
...
![](../images/anomalies.png){.screenshot fig-alt="Security anomalies review page with open findings and acknowledge actions"}
...
[deployment guide](../deployment.qmd#security-anomaly-detection).
