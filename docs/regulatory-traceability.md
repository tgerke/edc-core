...
| E6-06 | Security incident detection and response | Reviewable structured access log (`/admin/access-log`); failed logins, lockouts, and session-binding violations audited; anomaly reporting still to build | 🟡 `auth.test.ts`, `access-log.test.ts` |
