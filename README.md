...
> **Status: alpha (v0.6.0).** The full feature set below is released as [v0.6.0](https://github.com/tgerke/edc-core/releases/tag/v0.6.0), but edc-core has not yet been used in a production study. See the [changelog](CHANGELOG.md) and the [user guide](https://tgerke.github.io/edc-core/).
