...
> **Status: alpha (v0.5.1).** The full feature set below is released as [v0.5.1](https://github.com/tgerke/edc-core/releases/tag/v0.5.1), but edc-core has not yet been used in a production study. See the [changelog](CHANGELOG.md) and the [user guide](https://tgerke.github.io/edc-core/).
